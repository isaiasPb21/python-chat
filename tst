...
def calcAlea (fim=1000):                 # Gerador de número aleatório
    aleatorio = random.randint(0,fim)
    return aleatorio

def calcPrimo (num):                       #  Modelador do número aleatório
    acumulador = 0
...
chaveE = calcPrimo(calcAlea(feedN-200))
chaveN = (numP * numQ)

chaves = (chaveE, chaveN)
